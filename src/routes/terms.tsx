...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The terms that apply when you use Deckly for study decks, quizzes, and local progress tracking." },
...
function TermsPage() {
  return (
    <LegalPage
      ...
      intro="These terms govern your use of Deckly. By using the app, you agree to use it responsibly and lawfully."
    >
      ...
      <section><h2>Your content</h2><p>You retain ownership of the material you add to Deckly. Deckly does not claim rights to your decks beyond what is needed to display them in this app.</p></section>
      <section><h2>Acceptable use</h2><p>Do not misuse Deckly, interfere with its operation, distribute malicious content, violate intellectual-property rights, or use the app for unlawful activity.</p></section>
      ...
      <section><h2>Availability</h2><p>Deckly may change or discontinue features. Uninterrupted access and permanent preservation of local data are not guaranteed. Keep copies of important study material.</p></section>
      ...
      <section><h2>Changes</h2><p>You may stop using Deckly at any time. Updated terms will show a revised effective date, and continued use after an update constitutes acceptance.</p></section>
    </LegalPage>
  );
}
